        ...
        <WorkshopForm />
            ...
            >
                <span class="text-p8 text-p-red-1">
                    <span id="shiny-text" class="text-p8 w-max bg-[linear-gradient(to_bottom,var(--color-p-red-1)_36%,var(--color-p-red-2)_36%)] bg-clip-text text-transparent group-hover:bg-[linear-gradient(to_bottom,var(--color-p-white)_36%,var(--color-p-white)_36%)]">
                        SHIP YOUR CLUB PROJECT
                    </span>
                </span>
            </button>
    </div>
